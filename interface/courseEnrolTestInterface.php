...
//course filename
$course_file = COURSE_PATH . "courseTestCodes.txt";
$cache_file = './cache/enrolCache.csv';
...
<div class="container well well-lg login3" style="margin-bottom: -4px;">
    ...
    <div class="titleWrapper"><h3 class="formTitle2">Course Enrolment List</h3></div>
    <div role="tabpanel">
        <!-- Nav tabs -->
    ...
    <form name="target" method="POST" id="target" action="courseEnrolTestInterface.php">
