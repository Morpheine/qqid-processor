...
class Database
{
    ...
    private function db_connect()
    {
        if($this->getType() == 1){
            ...
            $this->qry("SET character_set_client=utf8");
            $this->qry("SET character_set_connection=utf8");
            $this->qry("SET character_set_results=utf8");
            ...
            $this->setDb(odbc_connect('Market','market','2Much24Get'));
            if(!$this->getDb()){
                if(phpversion() < '4.0'){
    ...
    {
        $this->getDb()->close();
        echo "Successfully disconnected from Market!";
    }
