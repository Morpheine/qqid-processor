...
<!--    <script type="text/javascript" charset="utf-8" language="javascript" src="//code.jquery.com/jquery-1.11.1.min.js"></script>-->
    <script type="text/javascript" charset="utf-8" language="javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
...
<!--    <script type="text/javascript" charset="utf-8" src="include/extensions/Scroller/js/dataTables.scroller.min.js"></script>-->
    <style>
        .col-md-0 {
            width: 0%;
        }
...
//                "loadingIndicator": true,
                ...
                "dom": 'i<"filter-toggle">C<"clear">T<"clear">lfr<"row"t<"fade hide columnfilterbox col-md-0"W>><"clear">p',
//                "dom": 'i<"filter-toggle">C<"clear">T<"clear">lfr<"row"t<"fade hide columnfilterbox col-md-0"W>><"clear">S',
                tableTools: {
...
//                    "info": "_MAX_ entries",
            ...
            var $toggleFilters = $('<button/>', {
                ...
                "click": function() {
                            ...
                            $('.dataTables_scroll').yeahtoggleClass('col-md-12 col-md-10');
                        }
            });


//            $('#setV').click( function () {
//                table.fnFilter( $('#txt').val());
//            });
