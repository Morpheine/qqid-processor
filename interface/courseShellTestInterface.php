...
//course filename
$course_file = COURSE_PATH . "courseShellTestCodes.txt";
...
<head>
    ...
    <script src="include/js/jquery.are-you-sure.js"></script>
</head>
<body>
<div class="container well well-lg login3" style="margin-bottom: -4px;">
    ...
    <form name="target" method="POST" id="target" action="courseShellTestInterface.php">
<!--    <form name="target" method="POST" id="target" action="courseShellTestInterface.php" onsubmit="setFormSubmitting()">-->
...
//        $("#target").submit(function (e) {
    ...
    // Function to notify the user that they've updated the list
    (function($) {
        if($("#isUpdated").val() == true){
            alertify.success("Course Shell List updated!");
        }

        $('#target').trigger('checkform.areYouSure');
